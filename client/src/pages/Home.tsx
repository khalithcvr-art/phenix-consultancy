...
/* ---------- data ---------- */
const expertiseData = [
  { title: "Precious Metal Refinery Project Management", description: "Structured project guidance from concept to commissioning, with disciplined coordination between technical, operational, and investment stakeholders.", Icon: ClipboardList, href: "/services/project-management", backgroundImage: "https://i.pinimg.com/1200x/16/81/1a/16811a9933e76da3cfc970d543f7467a.jpg" },
  { title: "Procurement Consulting & Technical Evaluation", description: "Vendor review, equipment selection, specification comparison, calibration standards procurement, and investment-grade purchasing support.", Icon: CheckCircle2, href: "/services/procurement-consulting", backgroundImage: "https://i.pinimg.com/1200x/3e/c2/77/3ec277d01642ec75eb7d9d0b63af0ee1.jpg" },
