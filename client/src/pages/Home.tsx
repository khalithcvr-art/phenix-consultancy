...
const expertiseData = [
  ...
  { title: "Instrument Training & Technical Staff Development", description: "Practical training programs that strengthen operator capability, laboratory reliability, and long-term technical independence.", Icon: GraduationCap, href: "/services/instrument-training", backgroundImage: "https://i.pinimg.com/1200x/8f/02/b2/8f02b2008406456dd233615919349495.jpg" },
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-clip">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden pt-20">
        <div className="absolute inset-0 z-0 overflow-hidden">
          <div className="kenburns w-full h-full opacity-100" style={{ backgroundImage: "url('/hero-background-v2.jpg')", backgroundSize: "cover", backgroundPosition: "center" }} />
